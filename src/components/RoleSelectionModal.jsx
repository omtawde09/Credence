...
const RoleSelectionModal = () => {
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            {/* Modal Card */}
            <div className="relative w-full max-w-[720px] bg-white/40 backdrop-blur-2xl border border-white/60 rounded-[32px] shadow-2xl overflow-hidden p-10 animate-in fade-in zoom-in duration-300 ring-1 ring-white/50">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <button
                        ...
                        className="group relative bg-blue-50/60 border-2 border-blue-200/60 hover:border-blue-500/80 rounded-3xl p-8 text-left transition-all duration-300 hover:shadow-2xl hover:shadow-blue-500/20 hover:-translate-y-1 active:scale-95 backdrop-blur-sm"
                    >
                    ...
                    <button
                        ...
                        className="group relative bg-purple-50/60 border-2 border-purple-200/60 hover:border-purple-500/80 rounded-3xl p-8 text-left transition-all duration-300 hover:shadow-2xl hover:shadow-purple-500/20 hover:-translate-y-1 active:scale-95 backdrop-blur-sm"
                    >
                        <div className="absolute top-4 right-4 opacity-0 group-hover:opacity-100 transition-opacity">
