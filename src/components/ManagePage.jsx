...
const ManagePage = () => {
    const budgets = [
        { name: 'Food & Dining', spent: 12000, limit: 15000, color: 'bg-orange-500' },
            ...
            <div className="md:ml-64 p-8 pt-6 transition-all duration-300">
                <header className="flex justify-between items-center mb-8">
                    ...
                    <div className="flex items-center gap-4">
                        <div className="relative hidden md:block">
                            ...
                            <input type="text" placeholder="Search" className="pl-10 pr-4 py-2 rounded-xl border border-orange-200 bg-white text-sm focus:outline-none focus:ring-1 focus:ring-green-800 w-64" />
                        </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="bg-white border border-orange-200 rounded-[32px] p-6 shadow-lg">
                        <div className="flex justify-between items-center mb-6">
                            <div className="flex items-center gap-3">
                                <Wallet size={24} className="text-green-800" />
                                <h3 className="font-bold">Budget Tracker</h3>
                            </div>
                            <button className="p-2 rounded-xl bg-green-800 text-white hover:bg-green-700">
                                <Plus size={16} />
                            </button>
                        </div>
                    ...
                    <div className="bg-white border border-orange-200 rounded-[32px] p-6 shadow-lg">
                        <div className="flex justify-between items-center mb-6">
                            <div className="flex items-center gap-3">
                                <Target size={24} className="text-green-800" />
                        ...
                        <div className="space-y-4">
                            {goals.map((goal, i) => (
                                <div key={i} className="p-4 bg-orange-50/50 rounded-xl">
                                    ...
                                    <div className="h-2 bg-orange-100 rounded-full overflow-hidden">
                                        <div className="h-full bg-green-500 rounded-full" style={{ width: `${(goal.current / goal.target) * 100}%` }} />
                                    </div>
                                </div>
                            ))}
                        </div>
                    ...
                    <div className="md:col-span-2 bg-green-800 text-white rounded-[32px] p-8 shadow-lg">
                        <div className="flex items-center gap-4 mb-4">
                            <PiggyBank size={32} />
                            <div>
                                <h3 className="text-xl font-bold">Auto-Save Enabled</h3>
                                <p className="text-green-100 text-sm">Your AI agent automatically saves 10% of every income</p>
                            </div>
                        </div>
                        <div className="flex gap-4 mt-6">
                            <button className="px-6 py-3 bg-white text-green-800 rounded-xl font-bold text-sm hover:bg-orange-50 transition-colors">
                                Adjust Settings
                            </button>
                            <button className="px-6 py-3 bg-green-700 text-white rounded-xl font-bold text-sm hover:bg-green-600 transition-colors">
                                View History
                            </button>
                        </div>
                    </div>
