        ...
        <div className="min-h-screen bg-orange-50/30 text-green-800">
            ...
            <div className="md:ml-64 p-8 pt-6 transition-all duration-300">
                ...
                <main className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="md:col-span-2 bg-white border border-orange-200 rounded-[32px] p-8 shadow-lg">
                        <div className="flex items-center gap-6 mb-8">
                            <div className="w-20 h-20 rounded-full bg-gradient-to-br from-green-800 to-green-600 flex items-center justify-center text-white text-2xl font-bold">
                            ...
                            <div>
                                ...
                                <span className="inline-block mt-2 px-3 py-1 bg-green-100 text-green-800 text-xs font-bold rounded-full">Premium Member</span>
                            </div>
                        </div>

                        <div className="space-y-4">
                            <div className="flex items-center gap-4 p-4 bg-orange-50/50 rounded-xl">
                    ...
                    <div className="bg-white border border-orange-200 rounded-[32px] p-6 shadow-lg">
                        ...
                        <div className="space-y-4">
                            ...
                            <button className="w-full py-3 bg-green-800 text-white rounded-xl font-bold text-sm hover:bg-green-700 transition-colors">
                                Change Password
                            </button>
                        </div>
                    </div>
